  ...
  return (
    <div className="flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20">
      ...
      <div>
        ...
        <p className="my-6 text-[15px] text-gray-500">Easily remove backgrounds from any image with just one click. <br className="max-sm:hidden"/> No design skills needed just upload, edit, and download in seconds!</p>
        <div>
